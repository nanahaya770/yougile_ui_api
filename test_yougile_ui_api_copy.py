...
"""
TODO
соблюдать грамотный naming(название)
декомпозиция, структурировать код(разделить на тестовые, фикстуры, на функции, на классы, на модули, на пакеты, библиотеки)
все константы перенести в conftest --start
все секретные данные перенести в .env
указать type hints в определении функций (запустить mypy)
написать справку в виде DocString 
